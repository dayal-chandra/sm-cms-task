...
const Blogs = () => {
  return (
    <div className="max-w-6xl mx-auto px-5 py-20">
      <h1 className="inter-font text-3xl text-center font-bold mb-10">
        Latest News and Blog
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        <div className="flex flex-col items-start justify-center space-y-4">
          <h1 className="roboto-font text-2xl font-semibold">
          ...
          <button className="inter-font py-2 px-8 text-white bg-[#CE4E61] rounded">
            Read More
          </button>
        </div>
        <div>
